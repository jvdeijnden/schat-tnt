...
var mymap = L.map('map_bladderscan', { zoomControl:false }).setView([51.4380614, 5.468464300000051], 19);
...
var Bladderscan_1 = L.marker([51.437725, 5.46830], {icon: orangePin});
Bladderscan_1.bindPopup(
'<table style="width:100%", border-collapse: collapse;> <tr> <th rowspan="2"><img src="Bladderscan.png" style="width:100px"</th> <th>Bladderscan_1</th></tr> <tr> <td><a href="Bladderscan_1.html">Meer info</a></td> </tr>'
);
...
var V2 = L.layerGroup([V2_map, Bladderscan_1]);
...
document.getElementById("Bladderscan_1_text").addEventListener("click", MoveToPin_1);

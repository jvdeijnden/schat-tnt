...
var mymap = L.map('map_ecg', { zoomControl:false }).setView([51.4380614, 5.468464300000051], 19);
...
//Pin: ECG_1
var ECG_1 = L.marker([51.438250, 5.468480], {icon: orangePin});
ECG_1.bindPopup(
'<table style="width:100%", border-collapse: collapse;> <tr> <th rowspan="2"><img src="ECG.png" style="width:100px"</th> <th>ECG_1</th></tr> <tr> <td><a href="ECG_1.html">Meer info</a></td> </tr>'
);
...
var V3 = L.layerGroup([V3_map,ECG_1]);
...
document.getElementById("ECG_1_text").addEventListener("click", MoveToPin_1);
